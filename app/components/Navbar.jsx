...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`${scrollPosition > 10 ? 'fixed t1199px:pt-2 t1199px:pb-[6px]  pt-[19px] pb-[11px] shadow-[0_4px_30px_0_rgba(0,0,0,0.078847658486)] w-full bg-white opacity-100 z-[99] top-0' : ' pt-[39px] t1199px:py-7 t1199px:px-0 relative z-[99]'} ${robotomono.className} ${isOpen && 'bg-[#131a3a]'} `}>
                <div className='src-line box-content '></div>
                <div className='wrapper box-content t1199px:!p-0  '>
                    <div className='flex justify-between items-center'>
                        <div className='mr-[15px] relative'>
                            ...
                            <a href="https://www.tabnine.com">
                                <svg xmlns="http://www.w3.org/2000/svg" width="180" height="54" fill="none" className='t767px:scale-[.8] t767px:left-[-18px] t767px:relative'>
                        ...
                        <div className=" t1199px:min-w-0 min-w-[680px]">
                            <button onClick={() => setIsOpen(!isOpen)} tabindex="0" aria-label="Toggle Main Menu" className="m-0  a1200px:hidden px-[20px] t767px:pr-0 t1199px:text-white t1199px:text-0
                         py-[15px] [text-indent:0px] [clip:auto] static bg-transparent normal-case overflow-visible z-10 [box-shadow:none] box-border align-top  leading-[1.3em] border-[none] rounded-none pointer-events-auto h-auto w-full max-h-[none] min-h-0  no-underline cursor-pointer max-w-full text-left t1199px:text-[0px] text-[12px] text-[rgb(51,_51,_51)] font-normal ">
                                <span style={{ height: '15px' }} className={`t1199px:before:h-[15px] w-[1.3em] text-center t767px:ml-0 t1199px:mr-0 t1199px:relative mr-[0.6em]  inline-block  leading-[1]  font-black before:absolute t1199px:before:w-[19px]  t1199px:before:block t1199px:before:bg-contain t1199px:before:bg-center t1199px:before:bg-no-repeat t1199px:before:content-[''] before:text-[#131A3A] t1199px:text-[#131a3a] t1199px:text-[34px] before:text-[34px] ${isOpen ? "before:bg-[url('./assets/taninemobilemenuclose.svg')]" : "before:bg-[url('./assets/tabninemobilemenu.svg')]"} cursor-pointer`}>
                                </span>Menu
                            </button>
                            <nav className=" align-top hidden a1200px:!block  relative  leading-[1.3em] rounded-none pointer-events-auto h-auto w-auto max-h-[none] min-h-0 text-left clear-both  text-[12px] text-[rgb(136,_136,_136)]">
                        ...
                        <div className="m-0 p-0 border-[0px] t1199px:hidden align-baseline">
